    ...
    <div class="admin-container">
        ...
        <div class="main-content">
            ...
            <div class="dashboard-stats">
                <div class="stat-card">
                    <h3>총 회원</h3>
                    <p><?= htmlspecialchars(number_format($member_count)) ?>명</p>
                </div>
                <div class="stat-card">
                    <h3>총 상품</h3>
                    <p><?= htmlspecialchars(number_format($product_count)) ?>개</p>
                </div>
                <div class="stat-card">
                    <h3>총 주문</h3>
                    <p><?= htmlspecialchars(number_format($order_count)) ?>건</p>
                </div>
                <div class="stat-card">
                    <h3>총 매출</h3>
                    <p><?= htmlspecialchars(number_format($total_sales)) ?>원</p>
                </div>
                <div class="stat-card">
                    <h3>리뷰</h3>
                    <p><?= htmlspecialchars(number_format($review_count)) ?>건</p>
                </div>
                <div class="stat-card">
                    <h3>문의사항</h3>
                    <p><?= htmlspecialchars(number_format($inquiry_count)) ?>건</p>
                </div>
            </div>
        </div>
    </div>
