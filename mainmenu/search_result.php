...
<body>
    ...
    <?php require_once 'queries/get_search_products.php';?>
    <?php
        ...
        <div class="container">
            ...
            <script>
                ...
                function updateFilters() {
                    ...
                    window.location.href = `?page=1&sort=${sort}&price_range=${price_range}&search_query=${search_query}`;
                }
            </script>
            ...
            <div class="pagination" id="pagination">
                <?php
                    ...
                    for ($i = 1; $i <= $total_pages; $i++) {
                        ...
                        echo "<a href='?page=$i&sort=$sort&price_range=$price_range&search_query=$search_query' class='$active'>$i</a>";
                    }
                    if ($page < $total_pages) {
                        $next_page = $page + 1;
                        echo "<a href='?page=$next_page&sort=$sort&price_range=$price_range&search_query=$search_query' class='next'>다음 <i class='fas fa-chevron-right'></i></a>";
                    }
                ?>
            </div>
        </div>
