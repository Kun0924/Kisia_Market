...
<body>
    ...
    <?php require_once 'queries/get_mousepad_products.php';?>
            ...
            <div class="content-section">
                <div class="product-grid">
                    ...
                    if (mysqli_num_rows($get_mousepad_products) > 0) {
                        while ($row = mysqli_fetch_assoc($get_mousepad_products)) {
                            // 상품 하나당 하나의 카드 출력
                            echo '<div class="product-card">';
                            echo '<a href="explain/mousepad_explain.php?id=' . $row['id'] . '">';
